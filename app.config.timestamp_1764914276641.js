...
db.$connect().then(() => console.log("Database connected successfully")).catch((e) => console.error("Database connection failed", e));
    ...
    },
    {
      ...
      plugins: () => [
        config("allowedHosts", {
          // @ts-ignore
          server: {
            allowedHosts: env2.BASE_URL ? [env2.BASE_URL.split("://")[1]] : void 0
          }
        }),
        tsConfigPaths({
