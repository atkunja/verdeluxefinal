...
export const Route = createFileRoute("/booking-quiz/new/phone")({
  component: PhonePage,
});
...
function PhoneContent() {
  ...
  const handleSendCode = () => {
    ...
    bookingAnalytics.selectionMade("phone", phone);
  ...
  return (
    <QuizIdentityLayout
      ...
      subtitle="We'll text you a 6-digit code to securely verify your identity."
    >
      <div className="space-y-6">
        ...
        <p className="text-center text-[10px] text-[#5c5a55]/60 uppercase tracking-widest font-semibold">
