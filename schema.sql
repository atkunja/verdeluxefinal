...
-- CreateIndex
CREATE INDEX "User_isPinned_idx" ON "User"("isPinned");
...
-- CreateIndex
CREATE INDEX "CallLog_externalId_idx" ON "CallLog"("externalId");
...
-- CreateIndex
CREATE INDEX "StripePayment_stripeIntentId_idx" ON "StripePayment"("stripeIntentId");
...
-- CreateIndex
CREATE INDEX "MercuryTransaction_accountId_idx" ON "MercuryTransaction"("accountId");

-- CreateIndex
CREATE INDEX "MercuryTransaction_transactionAt_idx" ON "MercuryTransaction"("transactionAt");
